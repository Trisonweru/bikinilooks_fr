          ...
          <div className="relative">
            <div className="hidden md:flex items-center">
              <input
                ...
                placeholder="Search..."
                className="border px-4 tex py-2 border-slate-600 text-   rounded-full text-sm w-full focus:border-[#752A78] focus:outline-none focus:ring-1 focus:ring-slate-600"
              />
            </div>
            {/* Results dropdown */}
            {searchTerm && (
