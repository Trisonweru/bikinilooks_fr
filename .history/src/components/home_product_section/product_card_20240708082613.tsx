  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {containsValue ? <div className='flex jus'><Link href={"/cart"}><span className='underline text-[#752A78] mt-2 px-4 py-1 '>View Cart</span></Link></div> : <button onClick={addToCartHandler} className="mt-2 w-full border border-[#752A78] text-[#752A78] hover:bg-[#752A78] hover:text-white px-4 py-1 text-sm rounded">Add to Cart</button>
        }      </div>
