...
function ServiceCard({ image, title, subTitle }: any) {
  return (
    ...
    >
      ...
      <div>
        <div className="inset-0 flex  items-center justify-center italic absolute text-3xl max-w-6xl md:max-w-3xl mr-auto ml-auto text-center text-white font-extrabold">
