  ...
  return (
    ...
    >
      <div className="relative">
        ...
        />
        <button
          className="absolute bottom-2 left-1/2 text-sm w-full transform -translate-x-1/2 bg-[#752A78] text-white px-4 py-2 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          onClick={(e) => {
            e.stopPropagation();
            handleModalOpen();
          }}
