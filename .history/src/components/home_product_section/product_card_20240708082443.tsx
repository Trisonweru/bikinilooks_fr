  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {containsValue ? <Link href={"/cart"}><span className='underline text-[#752A78]'>View Cart</span></Link> :        <button onClick={addToCartHandler} className="mt-2 w-full border border-[#752A78] text-[#752A78] hover:bg-[#752A78] hover:text-white px-4 py-1 text-sm rounded">Add to Cart</button>
}      </div>
