    ...
    <div className="bg-[#fff] py-0 flex flex-col space-y-8 items-center">
      <div className="relative flex items-center justify-center">
        ...
        <div className="relative bg-white px-4">
          <h2 className="text-2xl font-semibold text-[#BB4C48] text-center border-2 border-gray-300 px-4 py-2">
            {title}
          </h2>
        </div>
      </div>
        ...
        >
          <CarouselContent className="-ml-1">
            {slides.map((card: any, index: number) => (
              ...
              >
                <ServiceCard title={""} image={card?.image} category="Electronics" title="Awesome Gadget" price="999" />
              </CarouselItem>
            ))}
          </CarouselContent>
          <CarouselPrevious />
