    ...
    <nav className={`fixed w-4/5 top-0 z-50 transition-all duration-300 ${isScrolled ? 'h-16' : 'h-24'} bg-white shadow-lg`}>
      <div className="h-full flex items-center justify-between px-4">
        ...
        <div className="flex items-center justify-center flex-grow">
          <Link href={"/"}>
            <Image src='/images/logo.png' layout="contain" alt='logo' height={200} width={50} className={`font-bold transition-transform duration-300 ${isScrolled ? 'scale-75' : 'scale-100'}`} />
          </Link>
