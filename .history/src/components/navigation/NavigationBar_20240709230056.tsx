    ...
    <nav className={`fixed w-4/5 top-0 z-50 transition-all duration-300 ${isScrolled ? 'h-20' : 'h-36'} bg-white shadow-lg`}>
      <div className="h-full flex items-center justify-between px-4">
        ...
        <div className="flex items-center justify-center flex-grow">
          <Link href={"/"}>
            <Image src='/images/logo.png' layout="contain" alt='logo' height={250} width={150} className={`font-bold transition-transform duration-300 ${isScrolled ? 'scale-50' : 'scale-100'}`} />
          </Link>
