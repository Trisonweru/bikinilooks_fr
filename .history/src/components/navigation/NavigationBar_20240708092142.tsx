      ...
      <div className="h-full flex items-center justify-between px-4">
        <div className="flex items-center">
          <input
            type="text"
            placeholder="Search..."
            className='border px-4 py-2 border-yellow-600  rounded-md text-sm w-full focus:border-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-600'
          />
        </div>
              ...
              <Box sx={{ border: 1, p: 1, bgcolor: 'background.paper', width: '300px' }}>
                {items.length < 1 ? (
                  ...
                  <div>
                    ...
                    <div className="mt-4">
                      <p className="text-lg font-bold">Subtotal: Ksh{subtotal.toFixed(2)}</p>
                      <Link href="/cart">
