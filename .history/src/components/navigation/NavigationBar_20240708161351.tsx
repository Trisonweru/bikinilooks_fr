    ...
    <nav className={`fixed w-4/5 top-0 z-50 transition-all duration-300 ${isScrolled ? 'h-16' : 'h-24'} bg-white shadow-lg`}>
      ...
      <div className="bg-[#752A78] h-12 flex items-center justify-center text-white text-sm shadow-left-right">
        <div className="flex space-x-8 items-center">
          <Link href={"/"} className={pathname == "/" ? "border px-4 py-2 rounded-full font-normal" : "px-4 py-2 rounded-full font-normal"}>
            <span>HOME</span>
          </Link>
          <Link href="/new-arrivals" className={pathname == "/new-arrivals" ? "border px-4 py-2 rounded-full font-normal" : "px-4 py-2 rounded-full font-normal"}>NEW ARRIVALS</Link>
          <Link href="/on-sale" className={pathname == "/on-sale" ? "border px-4 py-2 rounded-full font-normal" : "px-4 py-2 rounded-full font-normal"}>ON SALE</Link>
          <div
            className="relative"
          ...
          <Link href="/contact" className={pathname == "/new-arrivals" ? "border px-4 py-2 rounded-full font-normal" : "px-4 py-2 rounded-full font-normal"}>CONTACsT US</Link>
        </div>
      </div>
    </nav>
  );
