    ...
    <footer className="bg-[#fff] text-gray-500 p-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className='text-sm'>
            BikiniLooks is your affordable online store for authentic bikinis.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="#" className="hover:underline text-[#752A78] text-sm">About us</a></li>
            <li><a href="#" className="hover:underline text-[#752A78] text-sm">Return Policy</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className='text-sm'>
            P. O. BOX 64243-00620 NAIROBI,
            <br />off Western Bypass
