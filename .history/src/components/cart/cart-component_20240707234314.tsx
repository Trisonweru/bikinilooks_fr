...
const Cart: React.FC = () => {
  ...
  return (
    <div className="flex p-4 space-x-4 bg-white min-h-screen">
      <div className="w-2/3 p-4 border rounded shadow-lg">
        <h2 className="text-xl font-bold mb-4">Your Cartq</h2>
        {items.length === 0 ? (
          <p>No items in cart.<span><Link href="/">Continue shopping</Link></span></p>
        ) : (
      ...
      <div className="w-1/3 p-4 border rounded shadow-lg">
        ...
        <div className="flex space-x-2">
          <input
            ...
            className="flex-grow p-2 border rounded ring ring-[#752A78] outline-none"
          />
