...
const NewsletterSignup: React.FC = () => {
  ...
  return (
    <div className="bg-[#3F3F3F] p-8 text-white  shadow-md w-full mx-auto">
      ...
      {isSubmitted ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4 w-1/2 ml-auto mr-auto mt-4">
          <div>
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="bg-[#BB4C48] text-white px-4 py-2 rounded-md hover:bg-[#9A3B3B] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#BB4C48]"
            >
              Sign Up
            </button>
          </div>
