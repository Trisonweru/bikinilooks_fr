            ...
            <button
              ...
              className={
                from == "contact"
                  ...
                  : "bg-[] block border border-transparent duration-150 font-medium leading-5 mt-4 px-4 py-2 rounded-sm text-center text-sm text-[#4E9CDA] hover:text-white transition-colors w-full hover:bg-[#4E9CDA] focus:outline-none focus:shadow-outline-blue active:bg-white"
              }
            >
              Send
            </button>
