        ...
        <div className="w-full border rounded-sm md:border-0 p-1 md:p-4  border-gray-300">
          <form method="POST">
            ...
            <button
              ...
              className={
                from == "contact"
                  ? "bg-[#752A78] block border border-transparent duration-150 font-medium leading-5 mt-4 px-4 py-2 rounded-sm text-center text-sm text-white transition-colors w-full hover:bg-[#2c6a9d] focus:outline-none focus:shadow-outline-blue active:bg-white"
                  : "bg-[#752A78] block border border-transparent duration-150 font-medium leading-5 mt-4 px-4 py-2 rounded-sm text-center text-sm text-[#4E9CDA] hover:text-white transition-colors w-full hover:bg-[#4E9CDA] focus:outline-none focus:shadow-outline-blue active:bg-white"
              }
            >
              Send
            </button>
