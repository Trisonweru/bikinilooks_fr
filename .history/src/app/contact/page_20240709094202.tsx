            ...
            <button
              ...
              className={
                from == "contact"
                  ...
                  : "bg-[#752A78] block border border-transparent duration-150 font-medium leading-5 mt-4 px-4 py-2 rounded-sm text-center text-sm text-white hover:text-white transition-colors w-full hover:bg-[#752A78] focus:outline-none focus:shadow-outline-blue active:bg-white"
              }
            >
              Send
            </button>
