...
const ProductDetails: React.FC<ProductDetailsProps> = ({ id, image, category, title, price }: any) => {
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex mb-8">
        <img src={image} alt={product.title} className="w-1/2 object-cover rounded" />
