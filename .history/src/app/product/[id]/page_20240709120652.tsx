        ...
        <form onSubmit={handleReviewSubmit} className="mt-4 w-full">
          <div className="flex items-center mb-2">
            ...
            <input
              ...
              min="1"
              max="5"
              className='w-14 spa border px-4 py-2 text-center border-slate-600  rounded-md text-sm focus:border-[#752A78] focus:outline-none focus:ring-1 focus:ring-slate-600'
            />
          </div>
          <div className="mb-2">
