        ...
        <form onSubmit={handleReviewSubmit} className="mt-4 w-full">
          ...
          <div className="mb-2">
            ...
            <textarea
              ...
              className="            className='border px-4 py-2 border-slate-600  rounded-full text-sm w-full focus:border-[#752A78] focus:outline-none focus:ring-1 focus:ring-slate-600'
