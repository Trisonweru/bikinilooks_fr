        ...
        <div className="w-1/2 pl-8">
          ...
          <div className="flex items-center mb-4">
            ...
            <input
              ...
              className='w-16 mx-2 border rounded px-4 py-2 text-center border-slate-600   text-sm focus:border-[#752A78] focus:outline-none focus:ring-1 focus:ring-slate-600'
