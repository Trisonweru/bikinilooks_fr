...
export default function Login() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // Handle the case where response.data or response.data.data is undefined or null
    token = null; // or undefined, depending on your use case
    user = null;  // or undefined, depending on your use case
}
