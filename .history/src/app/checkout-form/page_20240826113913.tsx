    ...
    <div className="max-w-md mx-auto pt-32 pb-10 min-h-screen">
      ...
      <form className="space-y-4">
        ...
        <div>
          ...
          <textarea value={formData.deliveryNote} onChange={handleInputChange}             className="mt-1 block w-full  focus:border-[#752A78] focus:outline-none focus:ring-1 focus:ring-[#752A78] rounded-md border-gray-300 shadow-sm">
