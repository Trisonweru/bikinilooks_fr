...
export default function CheckoutForm() {
 ...
 value={formData.deliveryNote} onChange={handleInputChange} className="mt-1 block w-full  focus:border-[#752A78] focus:outline-none focus:ring-1 focus:ring-[#752A78] rounded-md border-gray-300 shadow-sm">
