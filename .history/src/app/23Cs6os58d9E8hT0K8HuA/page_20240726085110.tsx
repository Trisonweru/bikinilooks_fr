...
export default function Form() {
  ...
  const columns: GridColDef[] = [
    ...
    { field: 'product_image', headerName: 'IMAGE', width: 150, renderCell: (params) => <img src={params?.row?.product_image} /> },
    { field: 'product_name', headerName: 'NAME', width: 100 },
    { field: 'price', headerName: 'PRICE', width: 100 },
    { field: 'discount_type', headerName: 'DISCOUNT TYPE', width: 130 },
    { field: 'fixed_discount', headerName: 'FIXED DISCOUNT', width: 100 },
    { field: 'percentage_discount', headerName: '% DISCOUNT', width: 100 },
    { field: 'available_stock', headerName: 'STOCK', width: 100 }
  ];
        ...
        <div className="min-h-screen flex flex-col px-4 py-4 pb-10 justify-start bg-gray-100">
          {products?.map((item: any, index: any) =>
            <Accordion key={index}>
              ...
              <AccordionDetails>
                <DataGrid rows={item?.data} columns={columns} getRowId={(row) => row?.ID} />
              </AccordionDetails>
            </Accordion>
          )}
        </div>
