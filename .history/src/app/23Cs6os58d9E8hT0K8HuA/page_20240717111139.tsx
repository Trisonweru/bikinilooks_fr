    ...
    <Box sx={{ width: '100%', paddingTop: "120px" }}>
      <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
        <Tabs value={value} onChange={handleChange2} aria-label="basic tabs example">
          <Tab className='text-[#752A78] ' label="Product" {...a11yProps(0)} />
          <Tab className='text-[#752A78] ' label="Product Category" {...a11yProps(1)} />
          <Tab className='text-[#752A78] ' label="Theme Image" {...a11yProps(2)} />
        </Tabs>
      </Box>
      <CustomTabPanel value={value} index={0}>
        <div className="min-h-screen flex items-center mx-auto px-4 py pb-10 justify-center bg-gray-100">
      ...
      <CustomTabPanel value={value} index={1}>
        I           <div className="min-h-screen flex items-center mx-auto px-4 pt-32 pb-10 justify-center bg-gray-100">
        </div>
      </CustomTabPanel>
