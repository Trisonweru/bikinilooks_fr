      ...
      renderCell: (params) => {
        ...
        return (
          <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '100%', height: "100%" }} className="space-x-2">
            ...
            <TwitterShareButton url={productImage} title={shareContent}>
              <XIcon size={32} round />
            </TwitterShareButton>
            <WhatsappShareButton url={productImage} title={shareContent}>
              <WhatsappIcon size={32} round />
            </WhatsappShareButton>
            <LinkedinShareButton url={productImage} title={shareContent} >
              <LinkedinIcon size={32} round />
            </LinkedinShareButton>
            <TelegramShareButton url={productImage} title={productName} >
