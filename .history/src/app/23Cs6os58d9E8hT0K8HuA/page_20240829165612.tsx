              ...
              <Accordion key={index}>
                ...
                >
                  <div className='space-x-3'>
                    ...
                    <span className={item?.status === "COMPLETE" ? 'font-semibold text-green-500' : item?.status === "PENDING" || item?.status === "pending" ? "font-semibold text-indigo-900" :item?.status === "PROCESSING" ? "font-semibold text-orange-900": 'font-semibold'}>{item?.status}</span>
