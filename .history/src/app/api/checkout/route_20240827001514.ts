...
export async function POST(request: Request) {
  try {
    ...
    const response = await axios.post('https://sea-lion-app-bo3ep.ondigitalocean.app/product/addProductCategory', { amount: 100,mobileNumber:mobileNumber,email:email, }, {
      headers: {
