...
export default function CheckoutForm() {
  ...
  return (
    <div className="max-w-md mx-auto pt-32 pb-10 min-h-screen text-black">
      ...
      <form className="space-y-4">
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full py-2 px-2 border  focus:border-[#752A78] focus:outline-none focus:ring-1 focus:ring-[#752A78] rounded-md border-gray-300 shadow-sm"
            required
          />
        </div>
        <div>
