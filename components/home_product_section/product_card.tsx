...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <div className="bg-white border rounded-lg shadow-sm overflow-hidden cursor-pointer relative group mb-1">
      ...
      <div className="p-4">
        ...
        {containsValue ? (
          <div className="flex justify-end">
            <Link href={"/cart"}>
              <span className="underline text-[#752A78] mt-2 px-4 py-1 ">
                View Cart
              </span>
            </Link>
          </div>
          ...
          <button
            ...
            className="mt-2 w-full border border-[#752A78] text-[#752A78] hover:bg-[#752A78] hover:text-white px-4 py-1 text-sm rounded"
          >
            Add to Cart
          </button>
        )}{" "}
